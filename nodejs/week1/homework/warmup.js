...
const bigCircle = new Circle(30); // Area: 1256.64, Circumference: 125.66, Diameter: 40.00}
console.log(`Circle1: 
...
const mediumCircle = new Circle(20); // Area: 706.86, Circumference: 94.25, Diameter: 30.00
