...
const samsung10 = new Product("samsung10", 7000);
const airpods = new Product("airpods", 300);
const keyboard = new Product("keyboard", 150);
const trimmer = new Product("trimmer", 250);
const mouse = new Product("mouse", 400);
const iphone12 = new Product("iphone12", 9000);
const playstation4 = new Product("playstation 4", 3000);
...
shoppingCart.addProduct(samsung10);
